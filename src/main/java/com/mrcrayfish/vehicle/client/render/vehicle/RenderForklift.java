...
public class RenderForklift extends AbstractRenderVehicle<EntityForklift>
{
    @Override
    public void render(EntityForklift entity, float partialTicks)
    {
    	this.renderDamagedPart(entity, SpecialModels.FORKLIFT.getModel());
    ...
    @Override
    public void applyPlayerModel(EntityForklift entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
