...
public class VehicleProperties
{
    ...
    public static void register()
    {
        ...
        properties.setKeyPortPosition(new PartPosition(1.5, 2.75, 8.5, -67.5, 0, 0, 0.5));
        ...
        properties.setKeyPortPosition(new PartPosition(-2.95, 6.6, 1, -45, 0, 0, 0.5));
        ...
        properties.setBodyPosition(new PartPosition(1.3));
        properties.setFuelPortPosition(new PartPosition(12.0, 8.0, -10.25, 0, 90, 0, 0.25));
        ...
        properties.setFuelPortPosition(new PartPosition(12.0, 9, -10.25, 0, 90, 0, 0.25));
        ...
        properties.setKeyPortPosition(new PartPosition(-2.5, -0.7, 10.6, -67.5, 0, 0, 0.5));
        properties.setDisplayPosition(new PartPosition(0.85F));
        properties.addSeat(new Seat(new Vec3d(0, 6, 0), true));
